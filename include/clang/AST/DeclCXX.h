...
public:
  ...
  bool isArisenContract() const { return hasAttr<ArisenContractAttr>(); }
  bool isArisenAction() const { return hasAttr<ArisenActionAttr>(); }
  bool isArisenTable() const { return hasAttr<ArisenTableAttr>(); }
  bool isArisenIgnore() const { return hasAttr<ArisenIgnoreAttr>(); }
  bool hasArisenRicardian() const { return hasAttr<ArisenRicardianAttr>(); }
  ArisenActionAttr* getArisenActionAttr() const { return getAttr<ArisenActionAttr>(); }
  ArisenTableAttr*  getArisenTableAttr() const { return getAttr<ArisenTableAttr>(); }
  ArisenContractAttr*  getArisenContractAttr() const { return getAttr<ArisenContractAttr>(); }
  ArisenRicardianAttr*  getArisenRicardianAttr() const { return getAttr<ArisenRicardianAttr>(); }
...
public:
  ...
  bool isArisenAction() const { return hasAttr<ArisenActionAttr>(); }
  bool isArisenNotify() const { return hasAttr<ArisenNotifyAttr>(); }
  bool isArisenContract() const { return hasAttr<ArisenContractAttr>(); }
  bool hasArisenRicardian() const { return hasAttr<ArisenRicardianAttr>(); }
  ArisenActionAttr* getArisenActionAttr() const { return getAttr<ArisenActionAttr>(); }
  ArisenNotifyAttr* getArisenNotifyAttr() const { return getAttr<ArisenNotifyAttr>(); }
  ArisenContractAttr* getArisenContractAttr() const { return getAttr<ArisenContractAttr>(); }
  ArisenRicardianAttr* getArisenRicardianAttr() const { return getAttr<ArisenRicardianAttr>(); }
