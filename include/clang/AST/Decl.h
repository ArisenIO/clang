...
public:
  ...
  bool isArisenWasmABI()const;
  std::string getWasmABI()const;
  bool isArisenWasmEntry()const;
  bool isArisenWasmImport()const;
  bool isArisenWasmAction()const;
  std::string getArisenWasmAction()const;
  bool isArisenWasmNotify()const;
  std::string getArisenWasmNotify()const;
