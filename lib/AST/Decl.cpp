...
bool RecordDecl::isArisenIgnore() const { return hasAttr<ArisenIgnoreAttr>(); }
...
bool FunctionDecl::isArisenWasmABI()const { return hasAttr<ArisenWasmABIAttr>(); }
std::string FunctionDecl::getWasmABI()const { return getAttr<ArisenWasmABIAttr>()->getAbi(); }
bool FunctionDecl::isArisenWasmEntry()const { return hasAttr<ArisenWasmEntryAttr>(); }
bool FunctionDecl::isArisenWasmImport()const { return hasAttr<ArisenWasmImportAttr>(); }
bool FunctionDecl::isArisenWasmAction()const { return hasAttr<ArisenWasmActionAttr>(); }
std::string FunctionDecl::getArisenWasmAction()const { return getAttr<ArisenWasmActionAttr>()->getName(); }
bool FunctionDecl::isArisenWasmNotify()const { return hasAttr<ArisenWasmNotifyAttr>(); }
std::string FunctionDecl::getArisenWasmNotify()const { return getAttr<ArisenWasmNotifyAttr>()->getName(); }
